    ...
    <main className="min-h-screen mt-6">
      <div className="w-11/12 mx-auto gap-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6 justify-between">
          <div className="h-[50vh] bg-[#2a2c2e] w-full rounded-2xl text-[#f6f4f0] flex flex-col justify-between p-4">
            ...
            <button className="border border-[#f4ce47] text-[#f4ce47] uppercase py-3 px-4 rounded-xl w-max">
              browse now
            </button>
          </div>
